...
class ProductTitle:
    ...
    "dimension": ["\s[ΦΔDF]?\d{1,2},?\d?X\d{1,2},?\d?", "[ΦΔDF]?\d{1,2},?\d?Χ\d{1,2},?\d?", "[^0+]\d{1,2},?\d?"],
    "grouping": ["ΣΕΤ\d\d?", "SET", "^ΣΕΤ", "ΣΕΤ", "\d*ΤΕΜ\w*\.?"],
    "unit": ["CM\w*\W?", "[\d\s](ΕΚ[ΑΤΟΣ\s]+)", "ΜΕΤΡ\w?\W?", "ML"],
    "code": ["ΚΩΔ:\S+\d", "\S+\d"],
    "material": ["PVC", "SEAGRASS", 'ΞΥΛ?Ι?Ν?\w?\w?', 'ΜΕΤΑΛΛ?Ι?Κ?\w?\w?', "ΨΑΘΙΝ\w\w?", "POLYRESIN", "ΠΟΛΥΡΕΖ\S+", "ΠΟΛΥΕΣΤΕΡ\w?", "POLYESTER", "ΠΟΛΥΡΕΖΙΝ", "ΡΗΤΙΝΗ\w", "ΓΥΑΛ[^Α]\w*", "ΚΕΡΑΜΙΚ\w\w?", "ΥΦΑΣΜ?Α?Τ?Ι?Ν?\w\w?", "ΒΕΛΟΥΔΙ?Ν?\w?\w?", "FIBERGLASS"],
    }
